...
import sys
sys.path.append('/scratch/aakriti/complex_task_100rob_layout_newtask/warehouse/envs')
...
#781327 - tight_2_64
#774160 - compact_2_64
#676213/167288 - usc_10 
#362872 - usc_64
#834401 - usc_32
# 747736/591473 - compact
# 538434/803865 - tight
...
class WarehouseEnv(gym.Env):
  ...
  def reset(self):
    ...
    while(count < self.agent_no):
      ...
      if((self.current_robot_state[count, 0] > 59) or (self.current_robot_state[count, 1] > 59)): continue
    ...
    while(count < self.agent_no):
      ...
      if((self.robot_positions[count, 0] > 59) or (self.robot_positions[count, 1] > 59)): continue
  ...
  def _compute_observation(self, action):
    ...
    # self.robot_test_time[self.old_min_r] = self.robot_test_time[self.old_min_r] + test_time_testing 
