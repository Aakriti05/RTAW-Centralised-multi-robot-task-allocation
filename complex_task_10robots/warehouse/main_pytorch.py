...
def main():
    ...
    parser.add_argument("--seed", type=int, default=4, help="Random seed [0, 2 ** 32)")
    ...
    parser.add_argument("--steps", type=int, default=4 * 10 ** 6, help="Total number of timesteps to train the agent.",)
