...
# robots = np.array([[2,2,0],[6,2,2]]).astype(float)
# tasks_load = np.array([[2,9,5,5], [4,4,0,0], [5,6,3,2], [2,4,1,2], [0,5,7,1]]).astype(float)
# tasks = tasks_load[:,0:4]
...
# # robots = np.loadtxt("seed_4data.txt", max_rows=agent_no)
# # tasks_load = np.loadtxt("seed_4data.txt", skiprows=agent_no)
# # tasks = tasks_load[:,0:4]

# robots = np.array([[2,2,0],[6,2,2]])
# tasks_load = np.array([[2,9,5,5], [4,4,0,0], [5,6,3,2], [2,4,1,2], [0,5,7,1]])
# tasks = tasks_load[:,0:4]
